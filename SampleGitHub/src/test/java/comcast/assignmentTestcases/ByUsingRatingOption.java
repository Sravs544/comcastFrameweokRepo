...
public class ByUsingRatingOption {
	...
	public static void main(String[] args) throws Throwable {
		...
		String rating = eLib.getDataFromExcel("org", 7, 4);
		...
		cnop.createOrg1(rating);	
        
		String actheaderinfo = cnop.getHeadertxt().getText();
        if (actheaderinfo.contains(coloumn1Data)) {
